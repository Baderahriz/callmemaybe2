...
❌ Bad practice:
I ask AI to write a whole function, copy-paste it into my project.
During peerevaluation, I can’t explain what it does or why. I lose credibility — and I fail my
project.
✅ Good practice:
...
Small language models (like the 0.6B parameter model you’ll use) are notoriously unreliable at generating structured output. When prompted to produce JSON, they might
...
directory and write output to the data/output/ directory.
You
...
These examples establish the expected complexity level.
However,
your solution will be tested with different prompts and function
sets.
You must implement proper JSON error handling for input files,
...
Note: The symbol " Ġ", indicates a preceding space; real tokenizers preserve such
...
Prompting the model with function
...
tokens and their string representations.
This is crucial for
...
The given input files may change during the peer review.
Do not
...
larger models.
This demonstrates the power of structural guidance
over raw model size.
### V.6 Testing Your Implementation
...
empty strings, large numbers, special
...
to allow anyone unfamiliar with the project (peers, staff, recruiters, etc.)
to quickly
...
Do not include the output/ directory in your repository.
It will be
